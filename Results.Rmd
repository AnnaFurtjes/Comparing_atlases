...
make_pretty = function(){
    ...
    theme(text = element_text(size=3),
            ...
            plot.title = element_text(face="bold", colour='#1A1A1A', size=3, hjust = 0.5),
...
save = lapply(
  ...
  function(n) 
    ...
    geom_histogram(aes(y = ..density..), fill = "#1b98e0")+
...
tiff(paste0("C:/Users/k1894405/OneDrive - King's College London/PhD/Projects/Comparing labelling protocols/results/plots/Schaefer_GrayVol.tiff"), width = 10, height = 5, units = "in", pointsize = 2, bg="white", res=800)
